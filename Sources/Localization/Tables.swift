...
public let zhTable: [S: String] = [
    ...
    .singleTraceAxisTime: "Time (s)",
    .singleTraceAxisAmp: "Amplitude",
    .singleTraceTimeRange: "时间范围",

    .tbSpectrum: "振幅谱",
    .spectrumLocal: "局部",
    .spectrumGlobal: "全局",
    .spectrumTitle: "振幅谱",
    .spectrumXAxis: "Frequency (Hz)",
    .spectrumYAxis: "Amplitude",
    .spectrumXRange: "X 范围",
    .spectrumYRange: "Y 范围",
    .spectrumNormalize: "分贝谱",
    .spectrumAuto: "自动",
    .spectrumUnitHz: "Hz",
    .spectrumUnitDb: "dB",
...
public let enTable: [S: String] = [
    ...
    .singleTraceAxisTime: "Time (s)",
    .singleTraceAxisAmp: "Amplitude",
    .singleTraceTimeRange: "Time range",

    .tbSpectrum: "Spectrum",
    .spectrumLocal: "Local",
    .spectrumGlobal: "Global",
    .spectrumTitle: "Amplitude Spectrum",
    .spectrumXAxis: "Frequency (Hz)",
    .spectrumYAxis: "Amplitude",
    .spectrumXRange: "X range",
    .spectrumYRange: "Y range",
    .spectrumNormalize: "dB spectrum",
    .spectrumAuto: "Auto",
    .spectrumUnitHz: "Hz",
    .spectrumUnitDb: "dB",
